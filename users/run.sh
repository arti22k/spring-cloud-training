...
java -jar -Dspring.cloud.config.uri=$CONFIG_URI -Dspring.rabbitmq.host=$RABBITMQ_HOST -Dspring.rabbitmq.username=$RABBITMQ_USERNAME -Dspring.rabbitmq.password=$RABBITMQ_PASSWORD /usr/local/service/users.jar
