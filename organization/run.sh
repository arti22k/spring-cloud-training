...
java -jar -Dcloud.stream.bindings.kafka.binder.zkNodes=$KAFKA_HOST -Dcloud.stream.bindings.kafka.binder.brokers=$KAFKA_HOST -Dspring.cloud.config.uri=$CONFIG_URI /usr/local/service/organization.jar
